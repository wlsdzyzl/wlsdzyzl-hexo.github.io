...
Hoppe的边收缩操作可推广为一般的顶点合并变换来描述$(v\_1,v\_2)\\rightarrow v$。而Garland和Heckbert引进了二次误差度量来刻画每一个顶点移动后引起的误差，对表面上的每一个顶点$v\_a$均有许多三角面片与之相邻，记$plane(v\_a)$为这些三角形所在平面所构成的集合，即：
